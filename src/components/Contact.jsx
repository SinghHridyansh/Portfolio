...
const socialLinks = [
  {
    href: "https://github.com/SinghHridyansh",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/hridyansh-singh-7a92a51a3/",
    icon: (
      <svg
        width="24"
        height="24"
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Reach out today to discuss our next collaboration!
          </p>
        ...
        <form
          action="https://getform.io/f/alljrena"
          method="POST"
        ...
        >
          ...
          <div className="mb-4">
            ...
            <textarea
              name="message"
              id="message"
              placeholder="Hi! Enter your text here."
              required
